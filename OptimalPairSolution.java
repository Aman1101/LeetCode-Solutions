...
public class OptimalPairSolution {
    ...
    /*List<List<Integer>> optimalUtilization(int deviceCapacity, List<List<Integer>>foregroundAppList,List<List<Integer>>backgroundAppList){
        ...
        listComparator = (o1, o2) -> o2.get(1).compareTo(o1.get(1));
        Collections.sort(foregroundAppList, listComparator);
...
//        background.add(temp);
        ...
        List<List<Integer>> list = new OptimalPairSolution().optimalUtilization(7, foreground, background);
    ...
    List<List<Integer>> optimalUtilization(int deviceCapacity, List<List<Integer>> foreground, List<List<Integer>> background) {
        ...
        return maxSum==0?new ArrayList<>(): hmap.get(maxSum);
